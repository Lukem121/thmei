<section id="services" class="text-gray-600 body-font">
    <div class="container px-5 pt-16 mx-auto">
      <div class="flex flex-col text-center w-full mb-10">
        <h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">WHAT CAN WE DO?</h2>
        <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900">Get your business online</h1>
      </div>
